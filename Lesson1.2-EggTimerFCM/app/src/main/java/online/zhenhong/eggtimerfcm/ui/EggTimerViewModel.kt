...
import online.zhenhong.eggtimerfcm.receiver.AlarmReceiver
import online.zhenhong.eggtimerfcm.R
import online.zhenhong.eggtimerfcm.util.cancelNotifications
...
class EggTimerViewModel(private val app: Application) : AndroidViewModel(app) {
    ...
    private var prefs =
        app.getSharedPreferences("online.zhenhong.eggtimerfcm", Context.MODE_PRIVATE)
